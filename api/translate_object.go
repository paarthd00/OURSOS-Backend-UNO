...
var staticJSON = map[string]interface{}{
	...
	"map": map[string]interface{}{
		...
		"hybrid":       "Hybrid",
		"default":      "Default",
		"whatsee":      "What do you see?",
		"tellmore":     "Tell us more",
		"next":         "Next",
		"edit":         "Edit",
		"alerterror":   "Please enter a description with a minimum of 10 characters",
		"ok":           "OK",
		"drag":         "Drag the marker to the alert Location.",
